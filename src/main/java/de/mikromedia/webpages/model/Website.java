...
public class Website {
    ...
    public Topic getWebpageByAlias(String webAlias) {
        ...
        for (RelatedTopic webpage : relatedWebpages) {
            ...
            String webpageAlias = webpageTopic.getChildTopics().getString(WEBPAGE_ALIAS, null);
            // Note: Alias should never be null as it is auto-generated by default
            if (webpageAlias != null && webpageAlias.equals(webAlias)) {
